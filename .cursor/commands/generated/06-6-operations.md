...
## Purpose
Use the protocol at `unified_workflow/phases/6-operations.md` to complete this phase. Follow the unified template and capture evidence for the orchestrator.
